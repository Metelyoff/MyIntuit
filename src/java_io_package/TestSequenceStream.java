...
public class TestSequenceStream
{
	public static void main(String[] args){
		...
		try {
			...
			vector.add(new FileInputStream("/storage/emulated/0/AppProjects/MyIntuit/src/java_io_package/file1.txt")); 
			vector.add(new StringBufferInputStream("\nEnd of file1, begin file2\n"));
			vector.add(new FileInputStream("/storage/emulated/0/AppProjects/MyIntuit/src/java_io_package/file2.txt"));
			vector.add(new StringBufferInputStream("\nEnd of file2"));
